...
import { TournamentOpsPageSection } from './components/TournamentOpsPageSection';
import {
...
export function TournamentOpsPage() {
  ...
  return (
    <TournamentOpsPageSection
      ...
      state={state}
      tables={tables ?? createEmptyLoadState()}
      records={records ?? createEmptyLoadState()}
      appeals={appeals ?? createEmptyLoadState()}
      selectedTableId={workbench.selectedTableId}
      playerNames={workbench.playerNames}
