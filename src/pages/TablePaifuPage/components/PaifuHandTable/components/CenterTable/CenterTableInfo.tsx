import { getPaifuTileCode, type PaifuRound as PaifuRoundSummary, type PaifuTile } from '@/objects';
import { getDoraIndicators, getRemainingTileCount, getRoundTitle } from '../../../../functions/getReplayCore';
