...
import type { MeldTile, RiverDiscard } from './replay.snapshot.types';
import { removeFirstMatchingTile } from './replay.snapshot.hands';
import { getOpenMeldSidewaysIndex } from './replay.snapshot.relations';

export function claimLastDiscard(
  ...
  for (const seat of seatOrder) {
    ...
    const claimedIndex = findLastDiscardIndex(river, tile);
