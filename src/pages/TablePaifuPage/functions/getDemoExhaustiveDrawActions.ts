...
import { southAfterOpenKan } from '../objects/TablePaifuDemoHands';
import { exhaustiveDrawHands } from '../objects/TablePaifuDemoHandSets';
...
export function getDemoExhaustiveDrawActions(): PaifuAction[] {
  return [
    {
      sequenceNo: 3,
      actor: 'player-south',
