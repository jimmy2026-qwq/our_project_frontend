...
import { LineupRoster, ToggleArrow } from './tournament-detail.participants.shared';
import type { LineupSubmission } from '../hooks/tournament-detail.participants-lineup';
