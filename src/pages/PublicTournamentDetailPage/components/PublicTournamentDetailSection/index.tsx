...
import { PublicTournamentDetailNotFound } from '../PublicTournamentDetailFrame';
...
import { PublishBlockedDialog } from './components/TournamentDetailPanels';
import { TournamentRulesDialog } from './components/TournamentRulesDialog';
import { detailShellClassNames } from './styles';
import { useTournamentDetailRuntime } from './hooks/TournamentDetailRuntime.hooks';
import { useTournamentDetailWorkbench } from './hooks/TournamentDetailWorkbench.hooks';
...
export const PublicTournamentDetailSection = ({
  ...
  if (!state.item || !workbench) {
    return <PublicTournamentDetailNotFound title="Tournament not found" />;
  }
