import type { TournamentMatchRecordView, TournamentTableView } from '@/objects';
import type {
  MatchRecordSummary,
  TableDetail,
    ...
    (orderedResults.length > 0
      ? orderedResults
          .map((seat) => {
            ...
            return `${seat.placement}. ${seat.playerId}${finalPoints}${scoreDelta}`;
          })
          .join(' / ')
      : '');
