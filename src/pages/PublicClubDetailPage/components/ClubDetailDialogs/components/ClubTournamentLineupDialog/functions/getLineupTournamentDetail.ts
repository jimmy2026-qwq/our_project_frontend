...
export function createFallbackTournamentDetailForLineup(
  tournament: ClubTournamentItem,
  fallbackStages: TournamentOperationsStageView[],
): TournamentDetailView {
  return {
...
export function toDetailStageFromStageDirectoryEntry(
...
export function toDetailStageFromPublicStage(
...
export function mergeTournamentStages(
