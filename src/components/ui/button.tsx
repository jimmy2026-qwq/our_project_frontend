...
const buttonVariants = cva(
  [
    ...
    '[font-family:"JetBrains_Sans","Segoe_UI",sans-serif] font-medium text-[#f2f7fb] no-underline',
    'border border-[rgba(176,223,229,0.14)]',
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        danger: 'rounded-2xl border-[rgba(236,197,122,0.4)] bg-[rgba(5,14,23,0.88)] text-[#ecc57a]',
