...
export function Select({ className, children, ...props }: SelectHTMLAttributes<HTMLSelectElement>) {
  return (
    <select
      data-slot="select"
      className={cx(
        'flex min-h-11 w-full rounded-[14px] border border-[rgba(176,223,229,0.14)]',
        'bg-[rgba(5,14,23,0.88)] px-3.5 py-[11px] [font-family:"JetBrains_Sans","Segoe_UI",sans-serif] text-[#f2f7fb]',
