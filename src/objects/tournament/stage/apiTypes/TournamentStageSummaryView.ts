import type { AdvancementRule } from '../../stage/rules/progression/AdvancementRule';
import type { KnockoutRuleConfig } from '../../stage/rules/knockout/KnockoutRuleConfig';
import type { StageStatus } from '../StageStatus';
import type { SwissRuleConfig } from '../../stage/rules/swiss/SwissRuleConfig';
